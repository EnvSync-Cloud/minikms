...
// IssueMemberCertFromCSR creates an end-entity member certificate from a CSR.
// This is used in the BYOK flow where the client generates their own keypair
// and sends a CSR — the private key never leaves the client.
func IssueMemberCertFromCSR(
	csrDER []byte,
	memberID string,
	orgID string,
	role string,
