...
const (
	SessionService_IssueSessionChallenge_FullMethodName = "/minikms.v1.SessionService/IssueSessionChallenge"
...
type SessionServiceClient interface {
	// IssueSessionChallenge returns a single-use nonce bound to cert_serial.
...
func (c *sessionServiceClient) IssueSessionChallenge(ctx context.Context, in *IssueSessionChallengeRequest, opts ...grpc.CallOption) (*IssueSessionChallengeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IssueSessionChallengeResponse)
	err := c.cc.Invoke(ctx, SessionService_IssueSessionChallenge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSessionServiceServer) IssueSessionChallenge(context.Context, *IssueSessionChallengeRequest) (*IssueSessionChallengeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IssueSessionChallenge not implemented")
}
...
func _SessionService_IssueSessionChallenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IssueSessionChallengeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionServiceServer).IssueSessionChallenge(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionService_IssueSessionChallenge_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServiceServer).IssueSessionChallenge(ctx, req.(*IssueSessionChallengeRequest))
	}
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IssueSessionChallenge",
			Handler:    _SessionService_IssueSessionChallenge_Handler,
		},
		{
